...
<img width="1280" height="640" alt="banner (4)" src="https://github.com/user-attachments/assets/03d0580d-0849-4cab-a89f-dacfda03aefb" />


This project demonstrating an enterprise methodology for inventorying AI systems, classifying them under **EU AI Act Article 6** (high-risk classification) and **Article 7** (changes to high-risk use cases), documenting exceptions, and monitoring regulatory and system changes over time.
